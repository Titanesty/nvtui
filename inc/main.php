        ...
        <div class="page-header page-header-kyc">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7 text-center"><h1 class="page-title">Сайт переехал на </h1>
                        <b style="font-size: 52px;"><?= $sitename ?>.<span style="color:orange"><?= $sitedomen ?></span></b>
                        <p class="large">Всегда проверяйте адрес сайта, остерегайтесь мошенников</p>
...
<head>
    ...
    <meta name="description"
          content="<?= $sitename ?> - Настоящий сайт Нвути. Все комиссии берем на себя, бонус при регистрации. Произведем выплаты за 24 часа на любую платежную систему.">
    <!-- Fav Icon -->
    ...
    <div class="topbar is-sticky">
        <div class="container">
            <div class="">
                ...
                <center onclick="window.location.href='/'" class="desktop-nav"
                        style="cursor:pointer;font-weight: 600;padding: 5px;color: #fff;font-size: 25px;"><?= $sitename ?></center>
            </div>
        </div><!-- .container -->
    </div><!-- .topbar -->
    <div class="navbar">
        <div class="container">
            ...
            <div class="navbar-innr">
                ...
                <ul class="navbar-menu mmmob">
                    ...
                    <li><a class="asff4"
                           onclick="$('.asff4').removeClass('mfjkg');$('.main-content').hide();$('#game').show(); $(this).addClass('mfjkg'); $('#close-nav').trigger('click');">Играть</a>
                    </li>
                    <li><a class="asff4"
                           onclick="$('.asff4').removeClass('mfjkg');$('.main-content').hide();$('#profile').show(); $(this).addClass('mfjkg'); $('#close-nav').trigger('click');">Настройки</a>
                    </li>
                    <li><a class="asff4" onclick="location.href='<?= $site_support ?>'">Служба поддержки</a></li>

                    <li><a class="asff4"
                           onclick="$('.asff4').removeClass('mfjkg');$('.main-content').hide();$('#ref').show(); $(this).addClass('mfjkg'); $('#close-nav').trigger('click');">Мои
                            рефералы</a></li>
                    <li><a class="asff4"
                           onclick="$('.asff4').removeClass('mfjkg');$('.main-content').hide();$('#bonus').show(); $(this).addClass('mfjkg'); $('#close-nav').trigger('click');">Раздача</a>
                    </li>
                    <?php if ($is_admin == 1) { ?>
                ...
                <ul class="navbar-btns">
                    <li><a href="<?= $group ?>" target="_blank" class="btn btn-sm btn-outline btn-light"><em
                                    style="color: #3b5998;" class="fab fa-vk"></em><span>Вконтакте</span></a></li>
                </ul>
            </div><!-- .navbar-innr -->
        </div><!-- .container -->
    </div><!-- .navbar -->
...
<div class="card-block" style="display:none">
    <div class="card-text">
        ...
        <p>Глобальный прогресс не стоит на месте и сегодня есть у каждого возможность играть в нвути онлайн с мобильных
            устройств. Наш настоящий сайт v полностью адаптивен к вашим гаджетам. Официальный сайт становится доступен
            вне дома, будь-то работа, школа или парк.</p>
        <p>Другими словами, сервис Нвути предлагает своим пользователям играть с мобильных устройств, причем для этого
        ...
        <p>Так как в начале каждой игры виден хеш-код игры, благодаря ему не составит труда проверить сражение нвути.
            Вкладывая средства, вы можете быть уверены в том, что администрация сайта не выдает вам фальшивые данные,
        ...
        <p>При этом на счет начисляются настоящие деньги, следовательно пользователь может поэкспериментировать с
            разнообразными стратегиями. Мы постоянно предоставляет различные бонусы и настоящие раздачи денег, которые
            дают шанс выиграть приз - Джек-пот.</p>

        <h3>Делитесь с друзьями ссылкой нвути</h3>
        <p>Приглашайте друзей выиграть денежный куш, сидя дома на диване или кресле, где вас ничего не отвлекает.
            Продвинутая реферальная система начисляет 10% за каждый депозит. Для этого проделайте один легкий шаг -
            отправьте ему ссылку на <b>сайт Нвути бест</b> или разместите в социальных сетях, форумах.</p>
        <p>На подлинном сайте поддерживается более 20 видов оплаты, таких как: QIWI, WebMoney, VISA, MasterCard, Dash,
            Bitcoin, Payeer и многие другие. Посетители мгновенных игр часто задаются вопросом: «А какая у вас комиссия
            при пополнении?» Мы с радостью отвечаем, что на сайте <b>nvuti</b> никогда не было и не будет издержек.</p>
        <p>По всем вопросам, связанным с регистрацией, можно проконсультироваться со службой онлайн-техподдержки,
            доступной в любое время.</p>

        <h4>Быстрые выплаты на настоящем сайте <?= $sitename ?></h4>
        <p>Программисты нашего официального сайта тащтельно слядет за игрой нвути. Благодаря им, вывод осуществляется за
            считанные минуты на любую платежную систему электронных денег.</p>
        <p>Хотим заметить, что выплата возможна только на кошелек с которого был пополнен баланс на сайте нвути. Это
            одна из мер безопасности сайта <?= $sitename ?> для защиты вашего баланса аккаунта от мошенников.</p>
...
<div class="page-content">
        ...
        <div class="row">
            <div class="aside sidebar-right col-lg-3 ">
                <a href="#" data-toggle="modal" data-target="#promo"
                   class="btn btn-info btn-xl btn-between w-100 mgb-1-5x">Активировать промокод <em
                        ...
                        <div class="token-balance">
                            ...
                            <div class="token-balance token-balance-with-icon mobile" style="margin-bottom: 0px;">
                                <div class="token-balance-text">
                                    ...
                                    <span style="    color: #fff;font-weight: 500;font-size: 1.6em;line-height: 1;letter-spacing: -0.02em;"
                                          mybalanceMob="0.00" class="odometer" id="userBalanceMob">
                                        <?= $balance ?></span>
                                </div>
                                <div style="margin:0 auto;">
                                    <span style="font-size: 13px;" class="btn btn-xs btn-primary btn-auto"
                                          data-toggle="modal" data-target="#modalDeposit" onclick="getNowDeposits()">Пополнить</span>
                                    <span style="font-size: 13px;" class="btn btn-xs btn-primary btn-auto"
                                          data-toggle="modal" data-target="#withdraw" onclick="getLasterMyWithdraws()">Вывести</span>
                                </div>
    ...
    height: 50px;" class="token-balance-icon">
                                ...
                                <div class="token-balance-text">
                                    ...
                                    <span style="    color: #fff;font-weight: 500;font-size: 1.6em;line-height: 1;letter-spacing: -0.02em;"
                                          mybalance="0.00" class="odometer" id="userBalance"></span>
                                </div>


                            </div>
                            <div class="kjfwf" style="margin:0 auto;"><span style="font-size: 13px;"
                                                                            class="btn btn-xs btn-primary btn-auto"
                                                                            data-toggle="modal"
                    ...
                    <div class="card-innr">
                        <div class="token-rate-wrap row">
                            <div class="token-rate col-md-6 col-lg-12 ativemenu">
                                <a class="asff4 font-mid text-dark mfjkg" style="cursor:pointer"
                                   onclick="$('.asff4').removeClass('mfjkg');$('.main-content').hide();$('#game').show(); $(this).addClass('mfjkg'); ">Играть</a>
                            </div>
                        </div>
                        <div class="token-rate-wrap row">
                            <div class="token-rate col-md-6 col-lg-12">
                                <a class="asff4 font-mid text-dark" style="cursor:pointer"
                                   onclick="$('.asff4').removeClass('mfjkg');$('.main-content').hide();$('#profile').show(); $(this).addClass('mfjkg'); ">Настройки
                                    аккаунта</a>
                            </div>
                        </div>
                        <div class="token-rate-wrap row">
                            <div class="token-rate col-md-6 col-lg-12">
                                <a class="asff4 font-mid text-dark" style="cursor:pointer"
                                   onclick="location.href='<?= $site_support ?>'">Служба поддержки</a>
                                <div class="new-mes"
                                     style="position: absolute;height: 14px;width: 14px;border-radius: 50%;border: 2px solid #fff;background: #2c80ff;content: '';top: 5px;right: 0px; display:none"></div>
                            </div>
                        </div>
                        <div class="token-rate-wrap row">
                            <div class="token-rate col-md-6 col-lg-12">
                                <a class="asff4 font-mid text-dark" style="cursor:pointer"
                                   onclick="$('.asff4').removeClass('mfjkg');$('.main-content').hide();$('#ref').show(); $(this).addClass('mfjkg'); ">Мои
                                    рефералы</a>
                            </div>
                        </div>
                        <div class="token-rate-wrap row">
                            <div class="token-rate col-md-6 col-lg-12">
                                <div class="asff4 font-mid text-dark" style="cursor:pointer;"
                                     onclick="$('.asff4').removeClass('mfjkg');$('.main-content').hide();$('#bonus').show(); $(this).addClass('mfjkg'); ">
                                    Раздача
                                </div>
                            </div>
                        </div>
                        <div class="token-rate-wrap row">
                            <div class="token-rate col-md-6 col-lg-12">
                                <div class="font-mid text-dark" style="cursor:pointer"
                                     onclick="exit(); location.href = ''">Выход
                                </div>
                            </div>
                        </div>
                ...
                <div class="content-area card">
                    ...
                    <div class="card-innr">
                        ...
                        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#coinflip">Coinflip</a>
                            </li>
                                    ...
                                    <div class="game-tbl">
                                        <center>
                                            <div id="activeBorder" class="wheel-circle" style="margin-bottom:140px">
                                                <img id="x50" src="../images/wheel.svg" class="relll"
                                                     style="position:relative">
                                                <div class="arrow-chance" style="margin-top:-18%"><i
                                                            class="fas fa-location-arrow" id="chanceArrow"></i></div>
                                            </div>
                                        </center>
                                    </div>
                                        ...
                                        <center>
                                            <div class="amount-bet box">
                                                ...
                                                <div class="content amount-bet-content">
                                                    <div class="amout-bet-content-inp" style="width:100%">
                                                        <input class="input-bordered text-center" type="number"
                                            ...
                                            <div class="dice-game-box-percent">
                                                <button style="color: #fff;"
                                                        class="btn btn-wheel-black dice-game-box-percent-btn"
                                                        onclick="wheel('2')">x2
                                                </button>
                                                <button style="color: #fff;"
                                                        class="btn btn-danger btn-wheel-red dice-game-box-percent-btn"
                                                        onclick="wheel('3')">x3
                                                </button>
                                            </div>
                                            <div class="dice-game-box-percent">
                                                <button class="btn btn-wheel-blue dice-game-box-percent-btn"
                                                        onclick="wheel('5')" style="background: #345ed7;color: #fff;">x5
                                                </button>
                                                <button class="btn btn-wheel-yellow dice-game-box-percent-btn"
                                                        onclick="wheel('50')"
                            ...
                            <div class="tab-pane fad" id="coinflip">
                                ...
                                <div class="bets-tbl" id="betsss">
                                    <div class="amount-bomb box">
                                        ...
                                        <div class="content">
                                            <input style="width:100%;" class="input-bordered text-center"
                                            ...
                                            <div class="dice-game-box-percent coinflipButtons">
                                                ...
                                                <button type="button" style="color: #fff;width:33%"
                                                        class="text-center btn btn-success dice-game-box-percent-btn"
                                                        onclick="coinflipbet('1')">Орёл<sup>x2</sup></button>
                                                <button type="button" style="color: #fff;width:33%"
                                                        class="text-center btn btn-success dice-game-box-percent-btn btn-wheel-red"
                                                        onclick="coinflipbet('30')">Ребро<sup>x10</sup>
                                                </button>
                                                <button type="button" style="color: #fff;width:33%"
                                                        class="text-center btn btn-success dice-game-box-percent-btn btn-wheel-yellow"
                                    ...
                                    <div class="index__home__indicator__inner index__home__indicator__inner--line"
                                        ...
                                        <div class="index__home__indicator__inner__number is-rolling is-hidden "
                                            ...
                                            <div class="index__home__indicator__inner__number__roll is-negative ">
                                                <img alt="vk.com/id321223555" src="/cub.svg" class="roll-img"><span
                                                        id="nums">0.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="margin-top:30px">
                                        <div class="row no-gutters height-100">
                                            <input type="range" oninput="fun1()" id="r1" name="chance"
                                                   ...
                                                   min="2" value="50" max="98" step="0.01" class="range rangeFindOne">

                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                        <input style="float:left" class="input-bordered text-center col-md-4 dice-input"
                                               id="betSizeDice" value="1" placeholder="Сумма ставки">


                                        <button style="color:#fff; float:right" onclick="betdice()"
                                                class="btn btn-light btn-block col-md-4" id="betDice">Сделать ставку <i
                            ...
                            <div class="tab-pane fad" id="mines">
                                <center>
                                    ...
                                    <div class='mine-bets-tbl'>
                                        ...
                                        <button id="startmines" class="btn btn-primary"
                                                style="width:49%; box-shadow: 0 5px 23px 0 rgba(0, 125, 255, 0.3); color:#fff;margin-top: 10px;margin-bottom:8px;"
                                                onclick="startgame()">Начать игру
                                        </button>
                                        <button id="finishmines" class="btn btn-primary"
                                                style="width:49%; box-shadow: 0 5px 23px 0 rgba(0, 125, 255, 0.3); color:#fff;margin-top: 10px;margin-bottom:8px;"
                                                onclick="finishgame()" disabled="">Забрать
                                        </button>
                                        <br>
                                        ...
                                        <div class='select-bomb' style=''>
                                            ...
                                            <span class="btn btn-xs btn-auto select-bomb-min circle"
                                        ...
                                        <div style='display:inline-block; float:left'>
                                            ...
                                            <p><span class="" style="font-size:44px;" id="MineProfit">1.00</span> <span
                                                        style="font-size:44px;"> X</span></p>
                                        </div>
                                        <div style='display:inline-block; float:right'>
                                            <p><span style='margin-top:7px'>Выигрыш:</span></p>
                                            <p><span class="" style="font-size:44px;" id="win">0.00</span> <span
                                                        style="font-size:44px;"> Р</span></p>
                                        </div>
                                    </div>
                            </div>
          ...
          <num style="font-size:28px" id="ProfitBattle">2.00</num>
                                            ...
                                            <svg id="cricle" version="1" xmlns="http://www.w3.org/2000/svg" width="250"
                                                ...
                                                <defs>
                                                    <linearGradient id="grad2" x1="0%" y1="0%" x2="0%" y2="100%">
                                                        <stop offset="0%"
                                                              style="stop-color:#5dc0ff;stop-opacity:1"></stop>
                                                        <stop offset="100%"
                                                              style="stop-color:#0b6cee;stop-opacity:1"></stop>
                                                    </linearGradient>
                                                </defs>
                                                <defs>
                                                    <linearGradient id="grad1" x1="0%" y1="0%" x2="0%" y2="100%">
                                                        <stop offset="0%"
                                                              style="stop-color:#ff7365;stop-opacity:1;"></stop>
                                                        <stop offset="100%"
                                                              style="stop-color:#f92e7f;stop-opacity:1"></stop>
                                                    </linearGradient>
                                                </defs>
                                                <g class="chart" transform="translate(200, 200)">
                                                    <g class="timer" transform="translate(0,0)">
                                                        <g class="bets" id="circle"
                                                           style="transform: rotate(0deg); transition: transform 4s cubic-bezier(0.15, 0.15, 0, 1);">
                                    ...
                                    <div class="col-md-6 bets-tbl" style="">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="input-item input-with-label">
                                                    <label for="full-name"
                                                           class="input-item-label text-center">Сумма</label>
                                                    <input autocomplete="off" id="BetSizeBattle"
                                                           onkeyup="profitbattle();" class="input-bordered text-center"
                                                           value="1">
                                                </div><!-- .input-item -->
                                            ...
                                            <div class="col-6">
                                                <div class="input-item input-with-label"><label for="full-name"
                                                                                                class="input-item-label text-center">Процент</label><input
                                                            autocomplete="off" class="input-bordered text-center"
                                                            type="text" name="full-name" value="50" id="BetPerBattle"
                                                            onkeyup="battlechance(this); profitbattle()"></div>
                                                <!-- .input-item -->
                                            ...
                                            <div class="col-6">
                                                <span class="card-sub-title card-tyy1 text-center">0 - <span
                                                            id="MinRangeBattle">499</span></span>
                                                <div id="BattleMin" class="input-item input-with-label"><a
                                                            id="redselect" onclick="select_team('red', 'blue')" style=""
                                                            class="btn btn-light btn-block btn-outline"><i
                                                                class="fa fa-angle-down red"></i> Красный</a></div>
                                                <!-- .input-item -->
                                            </div>
                                            <div class="col-6">
                                                <span class="card-sub-title card-tyy1 text-center"><span
                                                            id="MaxRangeBattle">500</span> - 999</span>
                                                <div id="BattleMax" class="input-item input-with-label btn-block"><a
                                                            id="blueselect" style=""
                                                            onclick="select_team('blue', 'red')"
                                                            class="btn btn-light btn-block btn-outline"><i
                                                                class="fa fa-angle-up blue"></i> Синий</a></div>
                                                <!-- .input-item -->
                                        ...
                                        <button style="color:#fff; " onclick="battlebet()"
                                                class="btn btn-light btn-block" id="createBetBattle">Сделать ставку <i
                                                    class="fas fa-coins"></i></button>
                                        <div id="error_battle"
                                             style="display:none;pointer-events: none; box-shadow: rgba(255, 105, 114, 0.14) 0px 5px 23px 0px;"
                                             class="btn  btn-block bg-danger"></div>

                                        <div id="success_battle"
                                             style="display:none;pointer-events: none; box-shadow: rgba(255, 105, 114, 0.14) 0px 5px 23px 0px;"
                                             class="btn  btn-block bg-success"></div>
                                    </div>
                            </div> <!-- ROW -->
                            </center>
                            <div class="tab-pane fade active show" id="dice-game">
                                            ...
                                            <div class="row">
                                                <div class="col-12 mobileProfit">
                                                    <ul class="token-info-list text-center" style="padding-bottom:0px">
                                                        <li class="" style="font-size:64px;margin-top:-47px"
                                                            id="BetProfitD">1.11
                                                        </li>
                                                ...
                                                <div class="col-6">
                                                    <div class="input-item input-with-label">
                                                        ...
                                                        <input autocomplete="off" id="BetSize"
                                                               onkeyup="validateBetSizeD(this);updateProfit()"
                                                               class="input-bordered text-center" value="1">
                                                    </div><!-- .input-item -->

                                                    <div class="d-sm-flex justify-content-center"
                                                         style="width:100%;margin:0">
                                                        <span class="badge badge-dim badge-md badge-light"
                                                              style="min-width:0px!important; padding: 4px 6px;"
                                                              onclick="var x = ($('#BetSize').val()*2);$('#BetSize').val(parseFloat(x.toFixed(2)));updateProfit()">Удвоить</span>
                                                        <span onclick="$('#BetSize').val(Math.max(($('#BetSize').val()/2).toFixed(2), 1));updateProfit()"
                                                              class="badge badge-dim badge-md badge-light"
                                                              style="min-width:0px!important; padding: 4px 6px;margin-left:5px">Половина</span>
                                                    </div>
                                                    ...
                                                    <div class="d-sm-flex justify-content-center tll" style="">
                                                        <span onclick="var max = $('#userBalance').attr('myBalance');$('#BetSize').val(Math.max(max,1));updateProfit()"
                                                              class="badge badge-dim badge-md badge-light"
                                                              style="min-width:0px!important; padding: 4px 6px;">Макс</span>
                                                        <span onclick="$('#BetSize').val(1);updateProfit()"
                                                              class="badge badge-dim badge-md badge-light"
                                                              style="min-width:0px!important; padding: 4px 6px;margin-left:5px">Мин</span>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="input-item input-with-label"><label for="full-name"
                                                                ...
                                                                onkeyup="validateBetPercentD(this);updateProfit()">
                                                    </div><!-- .input-item -->
                                                    <div class="d-sm-flex justify-content-center"
                                                         style="width:100%;margin:0">
                                                        <center>
                                                            <span class="badge badge-dim badge-md badge-light"
                                                                  style="min-width:0px!important; padding: 4px 6px;"
                                                                  onclick="$('#BetPercent').val(Math.min(($('#BetPercent').val()*2).toFixed(2), 95));updateProfit()">Удвоить</span>
                                                            <span class="badge badge-dim badge-md badge-light"
                                                                  style="min-width:0px!important; padding: 4px 6px;"
                                                                  onclick="$('#BetPercent').val(Math.max(($('#BetPercent').val()/2).toFixed(2).replace(/.00/g, ''), 1));updateProfit()">Половина</span>
                                                        </center>
                                                    </div>
                                                    <div class="d-sm-flex justify-content-center tll">
                                                        <span class="badge badge-dim badge-md badge-light"
                                                              style="min-width:0px!important; padding: 4px 6px;"
                                                              onclick="$('#BetPercent').val(95);updateProfit()">Макс</span>
                                                        <span class="badge badge-dim badge-md badge-light"
                                                              style="min-width:0px!important; padding: 4px 6px;margin-left:5px"
                                                              onclick="$('#BetPercent').val(1);updateProfit()">Мин</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="heded">
                                                    ...
                                                    <div class="row" style="margin-top:-7px">
                                                        <div class="col-6">
                                                            ...
                                                            <div id="buttonMin" class="input-item input-with-label"><a
                                                                        onclick="betMin()" style="color:#fff"
                                                                        class="btn btn-light btn-block">Меньше</a></div>
                                                            <!-- .input-item -->
                                                        </div>
                                                        <div class="col-6">
                                                            <span class="card-sub-title card-tyy1 text-center"><span
                                                            ...
                                                            <div id="buttonMax"
                                                                 class="input-item input-with-label btn-block"><a
                                                                        style="color:#fff" onclick="betMax()"
                                                                        class="btn btn-light btn-block">Больше</a></div>
                                                            <!-- .input-item -->
                                                        </div>
                                                        <div class="col-12" style="margin-top:-20px">
                                                            <div style="background:#fff;padding:0px 20px!important"
                                                                 class="btn  btn-block"></div>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div id="succes_bet"
                                                                 style="background: linear-gradient(to right, #0ACB90, #2BDE6D);display:none;pointer-events:none;box-shadow: 0 5px 23px 0 rgba(0, 215, 126, 0.27);"
                                                        ...
                                                        <div class="col-12">
                                                            <div id="error_bet"
                                                                 style="display:none;pointer-events:none; box-shadow: 0 5px 23px 0 rgba(255, 105, 114, 0.14);"
                                                                 class="btn  btn-block bg-danger"></div>
                                                        </div>
                                                    ...
                                                    <center id="checkBet" data-toggle="modal"
                                                            ...
                                                            style="text-align: center; margin-top:5px;display:none;-webkit-user-select: none;-moz-user-select: none; cursor:pointer"
                                                            href="">Проверить игру
                                                    </center>
                                                    <div class="modal fade" id="checkDiceModal" tabindex="-1">
                                                        <div class="modal-dialog modal-dialog-md modal-dialog-centered">
                                                            <div class="modal-content"><a style="cursor:pointer"
                                                                                          class="modal-close"
                                                                                          data-dismiss="modal"
                                                                                          aria-label="Close"><em
                                ...
                                <div class="card-head has-aside" style="margin-top:80px">
                                    ...
                                    <div style="margin-left: 177px;display: inline-block;position: absolute;"
                                         class="circle-online pulse-online"></div>
                                    <span id='oe'
                                          style="margin-left: 194px;display: inline-block;position: absolute;margin-top: 3px;"><?= $online ?> </span>

                                    <div class="card-opt"><a style="opacity: 0.8;font-weight: bolder;"
                                                             onclick="$('.jghtt').fadeToggle(); $('.ngh').toggle();"
                                                             class="link link-light ">
                                            <span class="ngh"><em class="ti ti-angle-down"
                                                                  style="font-size: 17px;cursor:pointer"></em></span>
                                            <span class="ngh"
                                                  style="font-weight: 400; display: none;font-size: 17px;cursor:pointer"><em
                                                        class="ti ti-angle-up"></em></span>
                                        </a>
                                ...
                                <table class="table jghtt tnx-table table-responsive text-center"
                        ...
                        <div class="card-innr card-innr-fix">
                            <div class="card-head has-aside">
                                ...
                                <div class="card-opt"><a
                                            onclick="$('#createTicket').hide();$('#listTickets').fadeIn(1000);"
                                            style="cursor:pointer;color:#2c80ff" class="link ucap  "><em
                                                class="fas fa-arrow-left mr-2"></em> Назад</a></div>
                            </div>
                            ...
                            <div class="input-item input-with-label"><label class="input-item-label ">Тема</label><input
                                        id="sub" class="input-bordered" type="text" autocomplete="off"></div>
                            <div class="input-item input-with-label"><label
                                        class="input-item-label ">Сообщение</label><textarea id="mes"
                                                                                             class="input-bordered input-textarea"
                                                                                             autocomplete="off"></textarea>
                            </div>
                            <div id="notch" class="token-calc-note note note-plane mb-10" style="display:none"><em
                                        class="fas fa-info-circle text-light"></em><span style="font-size: 13px !important;
margin-bottom: 15px;" class="note-text text-light" id="notch_m"></span></div>

                            <div id="te" class="note note-plane note-danger note-sm pdt-1x pl-0"
                                 style="color: rgba(255,104,104,0.9) !important;display:none"></div>
                    ...
                    <div class="token-transaction  card-full-height" id="listTickets" style="display:none">
                        <div class="card-innr">
                            <div class="card-head has-aside">
                                ...
                                <div class="card-opt"><a
                                            onclick="$('#listTickets').hide();$('#createTicket').fadeIn(1000);"
                                            style="cursor:pointer;color:#2c80ff" class="link ucap  "><em
                                                class="fas fa-plus mr-2 mb-1"></em> Создать тикет </a></div>
                            </div>
            ...
            <div class="main-content col-lg-9" id="profile" style="display:none">
                <div class="content-area card">
                    <div class="card-innr">
                        ...
                        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#personal-data">Изменить
                                    пароль</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#settings">Социальные
                                    сети</a></li>
                        </ul><!-- .nav-tabs-line -->
                        <div class="tab-content" id="profile-details">
                            <div class="tab-pane fade show active" id="personal-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-item input-with-label"><label for="full-name"
                                                                                        class="input-item-label">Новый
                                                пароль</label><input id="resetPass" class="input-bordered"
                                                                     type="password"></div><!-- .input-item -->
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-item input-with-label"><label for="full-name"
                                                                                        class="input-item-label">Повторите
                                                пароль</label><input id="resetPassRepeat" class="input-bordered"
                                                                     type="password"></div><!-- .input-item -->
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <a id="error_resetPass" class="btn  btn-block btnError bg-danger "
                                           style="display:none; color:#fff;margin-bottom:15px; margin: 0 auto"></a>
                                        <a id="succes_resetPass" class="btn  btn-block btnSuccess"
                                           style="display:none; color:#fff; cursor:default;  margin-bottom:10px;    background: linear-gradient(to right, rgb(10, 203, 144), rgb(43, 222, 109));">Пароль
                                            изменен</a>
                                    </div>
                                </div>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <button class="btn btn-primary"
                                            style=" box-shadow: 0 5px 23px 0 rgba(0, 125, 255, 0.3);"
                                            onclick="resetPass()">Изменить
                                    </button>
                ...
                <div class="content-area card">
                    <div class="card-innr">
                        ...
                        <div class="referral-form">
                            ...
                            <div class="copy-wrap mgb-1-5x mgt-1-5x"><span class="copy-feedback"></span><em
                                        class="fa fa-link"></em><input type="text" class="copy-address"
                        ...
                        <div class="note note-plane note-light note-md font-italic"><em class="fas fa-info-circle"></em>
                            <p style="padding-top: 3px;">Pеферальная ссылка изменена</p></div>
                ...
                <div class="d-sm-flex justify-content-center">
                    ...
                    <div class="content-area card col-lg-12" style="border-radius:0 6px 6px 0">
                        <div class="card-innr">
                            ...
                            <table id="example1" class="display table-responsive dataTable no-footer"
            ...
            <div class="main-content col-lg-9" id="bonus" style="display:none">
                <div class="card-innr card">
                    <div class="status status-empty">
                        <div class="status-icon"><em class="ti ti-gift"></em></div>
                        <span class="status-text text-dark">Получайте каждый день до 100 на свой баланс абсолютно бесплатно,<br>Для получения необходимо подписаться на нашу <a
                                    href="<?= $group ?>" target="_blank">группу</a></span>
                        <div class="row">

                            <div class="offset-md-3 col-md-6">
                                <div style="transform: scale(0.65);" class="g-recaptcha"
                                     data-sitekey="<?= $sitekey ?>"></div>
                            </div>

                            <div class="offset-md-3 col-md-6">
                                <a class="btn btn-primary"
                                   style=" box-shadow: 0 5px 23px 0 rgba(0, 125, 255, 0.3); color:#fff;margin-top: 10px;"
                                   id="butPromo" onclick="getDaily()">Получить</a>
                            </div><!-- .col -->

                        </div>
                        <a id="error_promo" class="btn  btnError bg-danger "
                           style="display:none; color:#fff;margin-bottom:15px; margin: 0 auto;margin-top: 25px;cursor:default;"></a>
                        <a id="succes_promo" class="btn btnSuccess"
                           style="margin-top: 25px; display:none; color:#fff; cursor:default;  margin-bottom:10px;    background: linear-gradient(to right, rgb(10, 203, 144), rgb(43, 222, 109));"></a>
                    </div>
                </div>
                <p class="text-light text-center"><em class="fas fa-info-circle" style="font-size:11px"></em> Мы не
        ...
        <div class="modal-content"><a class="modal-close" data-dismiss="modal" aria-label="Close"><em
            ...
            <div class="popup-body">
                ...
                <div id="fk" style="display:none;">
                    <label for="token-address" class="input-item-label">Сумма:</label>
                    <div class="input-item input-with-label"><input class="input-bordered col-6" type="text"
                                                                    id="depositSize" value="100" style=""><span
                                class="input-note">* Все комиссии берем на себя</span></div>


                    <ul class="d-flex flex-wrap align-items-center guttar-30px">
                        <li><a onclick="deposit_default()" class="btn btn-primary"
                               style="color:#fff; box-shadow: 0 5px 23px 0 rgba(0, 125, 255, 0.3);" id='depositButton'>Далее</a>
                        </li>
                        <a id="error_deposit" style="color: rgb(255, 255, 255); display:none"
                           class="btn btnError bg-danger "></a>
    ...
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content"><a href="#" class="modal-close" data-dismiss="modal" aria-label="Close"><em
            ...
            <div class="popup-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-item input-with-label"><label for="swalllet" class="input-item-label">Выберите
                                систему </label><select autocomplete="off"
                                                        class="select-bordered select-block select2-hidden-accessible"
                                                        id="hide_search" onchange="withdrawSelect()" tabindex="-1"
                                                        aria-hidden="true">
                ...
                <div class="input-item input-with-label"><label for="token-address" class="input-item-label">Укажите
                        реквизиты:</label><input autocomplete="off" placeholder="+79XXXXXXXXX" class="input-bordered"
                                                 id="walletNumber" value=""><span class="input-note" id="cardLL"
                                                                                  style="display:none">Только для РФ</span>
                </div>
                <div class="input-item input-with-label"><label class="input-item-label">Сумма:</label><input
                            autocomplete="off" class="input-bordered" id="WithdrawSize" value=""></div>
                <span class="text-light  d-inline-flex align-items-center"><span class="mb-0"><small
                                id="limitsW">От <b><?= $min_withdraw_sum ?></b> до <b>75000</b> рублей за одну выплату</small></span> <span
                            class="badge badge-disabled ml-2">Комиссия: 0%</span></span>


                <a id="error_withdraw" class="btn  btn-block btnError bg-danger "
                   style="display:none; color:#fff;margin-bottom:15px; margin: 0 auto;margin-top: 10px;"></a>
                <a id="succes_withdraw" class="btn  btn-block btnSuccess"
                   style="margin-top: 10px;display:none; color:#fff; cursor:default;  margin-bottom:10px;    background: linear-gradient(to right, rgb(10, 203, 144), rgb(43, 222, 109));">Выплата
                    успешно создана</a>
                <div class="gaps-2x"></div>
                <div class="d-sm-flex justify-content-between align-items-center">
                    <button id="withB" onclick="createwithdraw();" class="btn btn-primary"
                            style="width:100px;box-shadow: 0 5px 23px 0 rgba(0, 125, 255, 0.3);">Вывести
                    </button>
                </div>
        ...
        <div class="modal-content"><a href="#" class="modal-close" data-dismiss="modal" aria-label="Close"><em
            ...
            <div class="popup-body">
                ...
                <center id="error_bonuss1" style="margin-top:15px;display: none;"><a id="error_bonuss"
                                                                                     class="btn btnError bg-danger "
                                                                                     style="color:#fff;margin-top:10px auto;"></a>
                </center>


                <div class="gaps-4x"></div>
                <center id="xrqexr" style="font-size:11px;margin-top:15px;opacity:0.7;cursor:pointer"
                        onclick="hideBonus()">Больше не показывать предложение
                </center>
...
<div class="modal fade show" id="promo" tabindex="-1" style="display: none; ">
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content"><a style="cursor:pointer" class="modal-close" data-dismiss="modal"
                                      aria-label="Close"><em class="ti ti-close"></em></a>
            <div class="popup-body" style=''>
                <center>
                    Введите промокод<br>
                    <input type='text' style='width:250px;' class='input-bordered' id='promoactive' value=''
                           placeholder='Промокод'><br>

                    <!-- ОПОВЕЩЕНИЯ -->
                    <div id="succes_promoactive"
                         style="width:250px; margin-top:5px; display:none; background: linear-gradient(to right, rgb(10, 203, 144), rgb(43, 222, 109)); pointer-events: none; box-shadow: rgba(0, 215, 126, 0.27) 0px 5px 23px 0px;"
                         class="btn btn-success btn-block"></div>

                    <div id="error_promoactive"
                         style="width:250px; margin-top:5px; display:none;pointer-events:none; box-shadow: 0 5px 23px 0 rgba(255, 105, 114, 0.14);"
                         class="btn  btn-block bg-danger"></div>
                    <!-- КОНЕЦ -->
                    <button id="activebutton" class="btn btn-primary"
                            style=" box-shadow: 0 5px 23px 0 rgba(0, 125, 255, 0.3); color:#fff;margin-top: 10px; width:250px"
                            onclick="activepromo()">Активировать
                    </button>
                    <br>
                    ...
                    <input type='text' style='width:250px;' class='input-bordered' id='createname' value=''
                           placeholder='Название'><br><br>
                    Сумма промокода<br>
                    <input type='text' style='width:250px;' class='input-bordered' id='createsum' value=''
                           placeholder='Сумма'><br><br>
                    Кол-во активаций промокода<br>
                    <input type='text' style='width:250px;' class='input-bordered' id='createactive' value=''
                           placeholder='Кол-во активаций'><br>
                    <!-- ОПОВЕЩЕНИЯ -->
                    <div id="succes_promocreate"
                         style="width:250px; margin-top:5px; display:none; background: linear-gradient(to right, rgb(10, 203, 144), rgb(43, 222, 109)); pointer-events: none; box-shadow: rgba(0, 215, 126, 0.27) 0px 5px 23px 0px;"
                         class="btn btn-success btn-block"></div>

                    <div id="error_promocreate"
                         style="width:250px; margin-top:5px; display:none;pointer-events:none; box-shadow: 0 5px 23px 0 rgba(255, 105, 114, 0.14);"
                         class="btn  btn-block bg-danger"></div>
                    <!-- КОНЕЦ -->
                    <button id="createbutton" class="btn btn-primary"
                            style=" box-shadow: 0 5px 23px 0 rgba(0, 125, 255, 0.3); color:#fff;margin-top: 10px; width:250px"
                            onclick="createpromo()">Создать
                    </button>
                    <br>
                </center>
