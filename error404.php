...
<head>
    ...
    <title><?=$sitename?>.<?=$sitedomen?> - 404 error</title><!-- Vendor Bundle CSS -->
            ...
            <div class="container">
                <div class="">
                    ...
                    <ul class="topbar-nav d-lg-none">
                        <li class="topbar-nav-item relative"><a class="toggle-nav" href="https://demo.themenio.com/tokenwiz/buy-token.html#">
            ...
            <div class="row">
                <div class="main-content col-12">
                    <div class="content-area ">
                        <div class="page-header page-header-kyc"><div class="container"><div class="row justify-content-center"><div class="col-lg-8 col-xl-7 text-center"><h2 class="page-title">Страница не найдена</h2><a href="/" class="btn btn-primary" style="margin-top:15px">На главную</a></div></div></div><!-- .container --></div>
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
    </div>
