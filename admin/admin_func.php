...
if($check_adm != 1) {
  ...
  if($check_adm == 1) {
    ...
    if($win == 0) {
      ...
      $mysqli->query($update_sql111);
    }
    if($lose == 0) {
      $update_sql112 = "Update kot_user set sliv = 0 WHERE id='$id'";
      $mysqli->query($update_sql112);
    }
...
$result_select = $mysqli->query($selecter);
